...
CTA in the likes of: 'Click to explore options or 'Tap to see how it works.' dont use 'to see models\what's available ... etc'
NO ('get approved') 'See what's available near you' ' 'available this weekend\month' etc!!!
