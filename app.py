            ...
            with gen_placeholder:
                ...
                with st.status("Running generation steps...", state="running", expanded=True) as status_log:
                    try:
                        ...
                        script_prompt = f"Create a short, engaging voiceover script for FB viral   video (roughly 15-20 seconds long, maybe 2-3 sentences) about '{topic}' in language {lang}. The tone should be informative yet conversational, '.  smooth flow. Just provide the script text, nothing else. create intriguing and engaging script, sell the topic to the audience. be causal and not 'advert' vibe. end with a call to action  .the text needs to be retentive and highly engaging. "
