                            ...
                            with cols[j]:
                                ...
                                if st.session_state[show_video_key]:
                                    try:
                                        ...
                                        if platform == 'tk':
                                            iframe_code = f"""
                                            <iframe height="600" width= "320" src="https://www.tiktok.com/embed/v2/{video_id}?autoplay=1"
                                              allow="fullscreen" allow="encrypted-media;" title="test"> scrolling="no" overflow: hidden< /iframe>
